    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-20 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center gap-2 px-4 py-2.5">
          ...
          <span className="text-sm font-semibold text-zinc-100">TatuPrompt</span>
          <span className="ml-auto hidden text-xs text-zinc-500 sm:inline">Salvo neste navegador</span>
        </div>
      </header>
